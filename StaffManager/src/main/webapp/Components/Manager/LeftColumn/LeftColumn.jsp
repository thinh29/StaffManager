...
<ul
	...
	<li class="nav-item"><a class="nav-link " href="/manager/staffs">
			<i class="fas fa-fw fa-users"></i> <span>Quản lý nhân viên</span>
	</a></li>
	<!-- Nav Item - Utilities Collapse Menu -->
	<li class="nav-item"><a class="nav-link " href="/manager/salary">
			<i class="fas fa-fw fa-suitcase"></i> <span>Quản lý lương</span>
	</a></li>
	<!-- Nav Item - Pages Collapse Menu 
	<li class="nav-item">
	...
	<li class="nav-item"><a class="nav-link " href="/manager/functions">
	...
	<!-- Nav Item - Tables -->
	<li class="nav-item"><a class="nav-link" href="/manager/chatRoom"> <i
