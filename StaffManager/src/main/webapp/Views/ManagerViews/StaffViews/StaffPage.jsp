		...
		<div class="row">
			<div class="col-md-6">
				<form class="stf-form-search" action="/manager/staffs" method="POST"
					...
					<!--project search type-->
					<input type="hidden" value="st-act" id="prj-so" name="option" />
													...
													<div class="modal-dialog modal-dialog-centered modal-sm">
														<div class="modal-content">
															<div class="modal-header">
																<label>Xóa nhân viên <Strong>${staff.fullName }</Strong></label>
															...
															<form
																...
																<div class="modal-body">
																	...
																	<div class="col-sm-12">
																		<div class="col-sm-12">
																			<h6 class="mb-0">Ngày kết thúc làm việc</h6>
																		</div>
																		<div class="col-sm-12 text-secondary">
																			<input type="date" class="form-control" value=""
																				name="finishWork" required="required">
																		</div>
																	</div>
																</div>
