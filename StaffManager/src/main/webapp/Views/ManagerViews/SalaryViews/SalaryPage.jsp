...
<head>
<meta charset="UTF-8">
<title>Thống kê lương | Quản lý nhân sự</title>
</head>
<body>
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h4 class="m-0 font-weight-bold text-primary">Quản lý lương nhân
				viên</h4>
		</div>
		<div class="row">
			<div class="col-12">
				<div class="row">
					...
					<div class="col-5">
						<div class=" text-right" style="margin: 10px;">
							...
							<button data-toggle="modal" data-target="#add-salary-period"
								class="btn btn-primary">
								<i class="fa fa-plus-square"></i> Thêm kỳ lương
							</button>
							<div class="modal fade" id="add-salary-period"
								data-backdrop="static" data-keyboard="false" tabindex="-1"
								aria-labelledby="staticBackdropLabel" aria-hidden="true">
								<div class="modal-dialog modal-dialog-centered modal-sm">
									<div class="modal-content">
										<div class="modal-header">
											<label>Thêm kỳ lương </label>
											<button type="button" class="close" data-dismiss="modal"
												aria-label="Close">
												<span aria-hidden="true">&times;</span>
											</button>
										</div>
										<form action="<c:url value='/manager/salary'/>" method="GET"
											onsubmit="lazySubmit(event)" id="add-slr-prd">
											<div class="modal-body">
												<input type="hidden" name="type" value="add">
												<div class="col-sm-12">
													<div class="col-sm-12">
														<h6 class="mb-0">Kỳ lương tiếp theo</h6>
													</div>
													<div class="col-sm-12 text-secondary">
														<input type="month" id="salaryPeriod" name="salaryPeriod"
															max="${maxPeriod}" value="${maxPeriod}">
													</div>
												</div>
											</div>
		...
		<div class="card-body">
									...
									<c:forEach var="item" items="${listSTM}" varStatus="loop">
										<tr class="row100 body">
											...
											<td class="cell100 column7">												
												...
												onclick="return false;" class="checked-box" />
											</td>
											<td class="cell100 column8"><a
												href="<c:url value='/manager/salary?type=view&id=${item.id }'/> "
			...
			<form action="<c:url value='/manager/salary'/>" id="formSort"
				...
				<!-- <input type="hidden" id="sortByAndName" name="sortByAndName" value=""> -->
				<input type="hidden" id="slrPeriodSort" name="slrPeriodSort"
					value=""> <input type="hidden" id="typeStaff"
					name="typeStaff" value="">
			</form>
		</div>
	</div>
