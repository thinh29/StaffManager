...
<body>
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Tìm kiếm dự án rác </h1>
		<div class="d-sm-inline-block ">
			<div class="d-sm-inline-block ">
			<a href="/admin/projects" class="btn btn-sm btn-primary shadow-sm"> <i class="fas fa-arrow-alt-circle-down fa-sm text-white-50"></i> Tất cả dự án
			</a>
		</div>
		</div>
	</div>
				...
				<div class="card-header py-3">
					<select class="form-control"
						...
						<option selected="selected"
							value="/admin/projects?type=search-trash&option=done&status=all">Tất
							cả dự án</option>
						<option value="/admin/projects?type=search-trash&option=done&status=finished">Đã
							hoàn thành</option>
						<option
							value="/admin/projects?type=search-trash&option=done&status=unfinished">Chưa
							hoàn thành</option>
					</select>
