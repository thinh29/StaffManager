...
<head>
<meta charset="UTF-8">
<title>Dự án đang nhận | Quản lý dự án</title>
</head>
<body>
	<!-- Page Heading -->
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Dự án đang nhận</h1>
	</div>
	<!-- Content Row -->
	<!-- Content Row -->
	<div class="row">
		...
		<div class="col-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					...
					<form action="<c:url value='/projects?type=view'/>" id="formSubmit"
						method="get">
						...
						<input type="hidden" value="" id="page" name="page" /> <input
							...
							type="hidden" value="view" id="type" name="type" />
					</form>
				</div>
			</div>
